...
void insertarRecursivo(struct NodoArbol *& raiz, struct Elemento elemento){
    if(esNodoVacio(raiz))
        ...
        } else if (raiz->elemento.cantidad == elemento.cantidad){
            if (raiz->elemento.dia > elemento.dia){
                insertarRecursivo(raiz->izquierda, elemento);
            } else if (raiz->elemento.dia < elemento.dia){
                insertarRecursivo(raiz->derecha, elemento);
            } else if (raiz->elemento.dia == elemento.dia){
                if (raiz->elemento.turno > elemento.turno){
                    insertarRecursivo(raiz->izquierda, elemento);
                } else if (raiz->elemento.turno < elemento.turno){
                    insertarRecursivo(raiz->derecha, elemento);
                }
            }
        } else if (raiz->elemento.cantidad < elemento.cantidad){
