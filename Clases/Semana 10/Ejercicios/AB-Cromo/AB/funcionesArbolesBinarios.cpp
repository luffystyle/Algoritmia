...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * arbolIzquierdo,
    ...
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo, elemento,cantidad, arbolDerecho);
    arbol.raiz = nuevoNodo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario arbolIzquierdo,
                         int elemento,int cantidad, struct ArbolBinario arbolDerecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo.raiz, elemento, cantidad,arbolDerecho.raiz);
    arbol.raiz = nuevoNodo;
}

void inserta_ab_izq(NodoArbol *arbol,int lote,int cant){
    NodoArbol * nuevoNodo = crearNuevoNodoArbol(nullptr,lote,cant,nullptr);
    arbol->izquierda = nuevoNodo;
}

void inserta_ab_der(NodoArbol *arbol,int lote,int cant){
    NodoArbol * nuevoNodo = crearNuevoNodoArbol(nullptr,lote,cant,nullptr);
...
//        return 0;
//    else
//        return nodo. + sumarNodosRecursivo(nodo->izquierda) + sumarNodosRecursivo(nodo->derecha);
//}
//
...
void recorridoPorNivel(ArbolBinario arbol){
