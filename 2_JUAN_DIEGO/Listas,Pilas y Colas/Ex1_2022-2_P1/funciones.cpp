...
void insertarAlInicio(struct Lista & tad, int hora,int sucursal,const char dia[]) {

    /*Se va cambiar por la función crear nodo*/
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->hora= hora;
    nuevoNodo->sucursal=sucursal;
    strcpy(nuevoNodo->dia,dia);
...
void insertarAlFinal(struct Lista & tad, int hora,int sucursal,const char dia[]) {
...
struct Nodo * crearNodo(int hora,int sucursal,const char dia[], struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->hora = hora;
    nuevoNodo->sucursal=sucursal;
    strcpy(nuevoNodo->dia,dia);
...
void imprime(const struct Lista & tad) {
    ...
    if (esListaVacia(tad)) {
        ...
        while (recorrido != nullptr) {
            ...
            cout <<recorrido->hora<<"("<<recorrido->sucursal<<")"<< recorrido->dia  ;
            recorrido = recorrido->siguiente;
        }
        cout << "]" << endl;
    }
