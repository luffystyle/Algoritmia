...
void imprime(const struct Lista & tad) {
    ...
    if (esListaVacia(tad)) {
        ...
        while (recorrido != nullptr) {
            ...
            cout << recorrido->elemento/100000000<<" "<<(recorrido->elemento%100000000)/1000000<<":"<<(recorrido->elemento%1000000)/10000;
            cout<<" "<<(recorrido->elemento%1000)/100<<":"<<recorrido->elemento%100;
            recorrido = recorrido->siguiente;
            cout<<endl;
        }
        cout << "]" << endl;
