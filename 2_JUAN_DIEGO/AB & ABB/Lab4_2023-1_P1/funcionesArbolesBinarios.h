...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *,char, int, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *,char, int,
                                                       struct NodoArbol * );

void plantarArbolBinario(struct ArbolBinario & , struct ArbolBinario & ,
                         char ,int , struct NodoArbol * );

void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, char,int,
                                                struct ArbolBinario &);
