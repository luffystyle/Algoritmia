...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol * izquierdo,char servidor, 
                               int velocidad, struct NodoArbol * derecho){
    struct NodoArbol * nuevoNodo = new struct NodoArbol;
    nuevoNodo->velocidad = velocidad;
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierdo,char servidor,
                         int velocidad, struct NodoArbol * derecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(izquierdo, servidor,velocidad, derecho);
    arbol.raiz = nuevoNodo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierdo,
                         char servidor,int velocidad, struct NodoArbol * derecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo.raiz, servidor,velocidad, derecho);
    arbol.raiz = nuevoNodo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierdo,
                         char servidor,int velocidad, struct ArbolBinario & arbolDerecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo.raiz, servidor,velocidad, arbolDerecho.raiz);
    arbol.raiz = nuevoNodo;
}
...
void imprimeNodo(struct NodoArbol * nodo){
    cout<<setw(3)<<"("<<nodo->servidor<<"-"<<nodo->velocidad<<")";
}
