...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol * izquierdo, 
                               char letra, struct NodoArbol * derecho){
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierdo,
    ...
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(izquierdo, letra, derecho);
    arbol.raiz = nuevoNodo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierdo,
                         char letra, struct ArbolBinario & arbolDerecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo.raiz, letra, arbolDerecho.raiz);
    arbol.raiz = nuevoNodo;
}
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierdo,
                         char letra, struct NodoArbol * derecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo.raiz, letra, derecho);
    arbol.raiz = nuevoNodo;
}
