...
void cargaBin(int *cromo,int numero, int cantidad){
    //llenando el cromosoma en 0
...
int cantPredecesores(int numero,int &pred1,int &pred2,int &pred3){
    int cantidad=0;
    int num= numero;
    pred1=0;//inicializamos los predecesores cada vez que entren por este lado
    pred2=0;
    pred3=0;
    while(num!=0){
        num /=10;
