...
void insertarAlInicio(struct Lista &, int ,int ,char );
void insertarAlFinal(struct Lista &, int ,int ,char);
void insertarEnOrden(struct Lista &, int);

struct Nodo * crearNodo(int hora,int sucursal,char dia, struct Nodo *);
...
void eliminaNodo(struct Lista &, int ,int ,char );
