...
void insertarAlInicio(struct Lista & tad, int hora,int sucursal,char dia) {
...
void insertarAlFinal(struct Lista & tad, int hora,int sucursal,char dia) {

    struct Nodo * ultimoNodo = obtenerUltimoNodo(tad);
    struct Nodo * nuevoNodo = crearNodo(hora,sucursal,dia, nullptr);
...
struct Nodo * crearNodo(int hora,int sucursal,char dia, struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->hora = hora;
    nuevoNodo->sucursal = sucursal;
    nuevoNodo->dia = dia;
...
void eliminaNodo(struct Lista & tad, int hora,int sucursal ,char dia) {
    struct Nodo * ultimo = nullptr;
    struct Nodo * recorrido = tad.cabeza;
    /*Avanzo hasta encontrar el elemento*/
    /*Si no lo encuentra no elimina nada*/
    while ((recorrido != nullptr) and (recorrido->hora != hora) and recorrido->sucursal!=sucursal and recorrido->dia !=dia) {
        ultimo = recorrido;
        recorrido = recorrido->siguiente;
    }
...
//        if(recorrido->dia == 'L') cout<<"Lunes: ";
//        if(recorrido->dia == 'M') cout<<"Martes: ";
//        if(recorrido->dia == 'm') cout<<"Miercoles: ";
//        if(recorrido->dia == 'J') cout<<"Jueves: ";
//        if(recorrido->dia == 'V') cout<<"Viernes: ";
        cout << "[";
