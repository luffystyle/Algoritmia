...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, struct Lote, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, struct Lote,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario, struct Lote,
                                                       struct ArbolBinario );
struct Lote raiz(struct NodoArbol * nodo);
