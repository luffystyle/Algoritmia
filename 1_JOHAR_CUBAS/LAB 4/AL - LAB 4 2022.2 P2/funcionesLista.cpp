...
void insertarAlInicio(struct Lista & tad, struct Lote elemento) {
...
void insertarAlFinal(struct Lista & tad, struct Lote elemento) {
...
struct Nodo * crearNodo(struct Lote elemento, struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->elemento = elemento;
...
struct Lote retornaCabeza(const struct Lista & tad){
