...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol * arbolIzquierdo,char tipo, 
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * arbolIzquierdo, char tipo,
                         int elemento, struct NodoArbol * arbolDerecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo, tipo,elemento, arbolDerecho);
    arbol.raiz = nuevoNodo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario arbolIzquierdo, char tipo,
                         int elemento, struct ArbolBinario arbolDerecho){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodoArbol(arbolIzquierdo.raiz,tipo ,elemento, arbolDerecho.raiz);
    arbol.raiz = nuevoNodo;
}
...
void imprimeNodo(struct NodoArbol * nodo){
    cout<<nodo->tipo<<" "<<setw(5)<<nodo->elemento<<" ";
}
