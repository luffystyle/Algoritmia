...
void insertarencola(struct Lista & tad, struct NodoArbol *nodoInsert) {

    struct Nodo * ultimoNodo = tad.cola;
    struct Nodo * nuevoNodo = crearNodo(nodoInsert, nullptr);
...
struct Nodo * crearNodo(struct NodoArbol *nodoInsert, struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->nodo = nodoInsert;
