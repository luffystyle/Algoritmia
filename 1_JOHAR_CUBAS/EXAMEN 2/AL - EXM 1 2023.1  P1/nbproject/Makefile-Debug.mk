...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/al_-_exm_1_2023.1__p1.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/al_-_exm_1_2023.1__p1.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/al_-_exm_1_2023.1__p1 ${OBJECTFILES} ${LDLIBSOPTIONS}
