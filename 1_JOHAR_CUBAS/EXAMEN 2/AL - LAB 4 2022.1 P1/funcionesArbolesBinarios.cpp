...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol * arbolIzquierdo, 
                               struct Elemento elemento, struct NodoArbol * arbolDerecho){
...
void imprimeNodo(struct NodoArbol * nodo){
    cout<<setw(8)<<nodo->elemento.campo1<<"-"<<nodo->elemento.campo2<<"-"<<nodo->elemento.campo3<<" ";
}
...
int sumarNodosRecursivo(struct NodoArbol * nodo){
    if(esNodoVacio(nodo))
        ...
        return nodo->elemento.campo1 + sumarNodosRecursivo(nodo->izquierda) + sumarNodosRecursivo(nodo->derecha);
}
