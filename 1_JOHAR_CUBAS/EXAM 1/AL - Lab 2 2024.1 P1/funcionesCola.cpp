...
void encolar(struct Cola & cola, int elemento,char prioridad){
    insertarencola(cola.lista, elemento,prioridad);
    //cout<<"Encolando: "<<elemento<<endl;
}

/*Elimina un elemento de la cola*/
int desencolar(struct Cola & cola,char &prioridad){
    if(esColaVacia(cola)){
        ...
        prioridad = retornaPrioridad(cola.lista);
