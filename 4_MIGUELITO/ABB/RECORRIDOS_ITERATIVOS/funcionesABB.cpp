    ...
    if(esNodoVacio(raiz))
        ...
        if(raiz->elemento.cantidad > elemento.cantidad)
            ...
            if(raiz->elemento.cantidad < elemento.cantidad)
                ...
                cout << "El elemento " << elemento.cantidad << "Ya se encuentra en el árbol" << endl;
}
...
//    if(esNodoVacio(nodo))
//        return false;
//    if(comparaABB(nodo->elemento.cantidad, dato) == 0)
//        return true;
//    if(comparaABB(nodo->elemento.codigo, dato) == 1)
//        return buscarRecursivo(nodo->izquierda, dato);
//    else
//        if(comparaABB(nodo->elemento.cantidad, dato) == -1)
