...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab3_2023-1_bowser_pilas.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab3_2023-1_bowser_pilas.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab3_2023-1_bowser_pilas ${OBJECTFILES} ${LDLIBSOPTIONS}
