...
Nodo *crearNodoNew(NodoArbol *nodoArbol, Nodo *sig) {
...
NodoArbol *retornarCabezaNew(Lista &lista) {
    return lista.cabeza->nodoArbol;
}


void insertarEnColaNew(Lista &lista, NodoArbol *nodoArbol) {
    Nodo *ultimoNodo = lista.cola;
    Nodo *nuevoNodo = crearNodoNew(nodoArbol, nullptr);
