...
struct NodoArbol * crearNuevoNodo(struct NodoArbol * izquierda, Elemento elemento, struct NodoArbol * derecha) {
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierda, Elemento elemento, struct NodoArbol * derecha) {
...
void plantarArbolBinario(struct NodoArbol *& raiz, struct NodoArbol * izquierda, Elemento elemento, struct NodoArbol * derecha){
    
    struct NodoArbol * nuevoNodo = crearNuevoNodo(izquierda, elemento, derecha);
    raiz = nuevoNodo;
}

void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierda, Elemento elemento, struct ArbolBinario & arbolDerecha) {
    struct NodoArbol * nuevoNodo = crearNuevoNodo(arbolIzquierda.raiz, elemento, arbolDerecha.raiz);
    arbol.raiz = nuevoNodo;
...
void imprimirNodo(struct NodoArbol * raiz){
    cout << setw(5) << raiz->elemento.tipo << "-"<<raiz->elemento.velocidad<< " ";
}
