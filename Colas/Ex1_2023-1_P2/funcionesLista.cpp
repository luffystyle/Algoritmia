...
void insertarAlInicio(struct Lista & tad, int codigo,int prioridad) {
...
struct Nodo * crearNodo(int codigo,int prioridad, struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->codigo = codigo;
    nuevoNodo->prioridad = prioridad;
...
//            estaImprimiendoLaCabeza = 0;
            cout <<"ISI00"<< recorrido->codigo<<","<<recorrido->prioridad;
            recorrido = recorrido->siguiente;
            cout << "]" ;
        }
